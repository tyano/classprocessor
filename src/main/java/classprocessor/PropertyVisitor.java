...
import classprocessor.impl.DefaultField;
import classprocessor.impl.DefaultProperty;
import static classprocessor.util.Strings.*;
    ...
    protected Field buildFieldFromVariableElement(VariableElement ve, Environment env) {
        ...
        if(ve.getKind() == ElementKind.FIELD) {
            ...
            for (AnnotationMirror annotation : annotations) {
                TypeElement fieldAnnotationType = elementUtil.getTypeElement(classprocessor.annotation.Field.class.getName());
            ...
            if(name.startsWith("get") || name.startsWith("set") || name.startsWith("is")) {
                ...
                if(property != null) {
                    ...
                    for (AnnotationMirror annotation : annotations) {
                        ...
                        TypeElement propertyAnnotationType = elementUtil.getTypeElement(classprocessor.annotation.Property.class.getName());
