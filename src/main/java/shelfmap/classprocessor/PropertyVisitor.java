...
import shelfmap.classprocessor.impl.DefaultField;
import shelfmap.classprocessor.impl.DefaultProperty;
import static shelfmap.classprocessor.util.Strings.*;
    ...
    protected Field buildFieldFromVariableElement(VariableElement ve, Environment env) {
        ...
        if(ve.getKind() == ElementKind.FIELD) {
            ...
            for (AnnotationMirror annotation : annotations) {
                TypeElement fieldAnnotationType = elementUtil.getTypeElement(shelfmap.classprocessor.annotation.Field.class.getName());
            ...
            if(name.startsWith("get") || name.startsWith("set") || name.startsWith("is")) {
                ...
                if(property != null) {
                    ...
                    for (AnnotationMirror annotation : annotations) {
                        ...
                        TypeElement propertyAnnotationType = elementUtil.getTypeElement(shelfmap.classprocessor.annotation.Property.class.getName());
